...
export const metadata: Metadata = {
  title: "Boulot Man — Africa's Professional Marketplace",
  description: "Find trusted technicians, engineers, and verified companies. Book reliable help in minutes with Boulot Man.",
  viewport: "width=device-width, initial-scale=1",
  icons: {
    icon: "/boulotman-logo.png",
    apple: "/boulotman-logo.png",
  },
};
  ...
  return (
    ...
    >
      ...
      <body className="min-h-screen flex flex-col" suppressHydrationWarning>
        {children}
        <Script src="https://code.iconify.design/iconify-icon/3.0.0/iconify-icon.min.js" strategy="beforeInteractive" />
      </body>
    </html>
  );
}
